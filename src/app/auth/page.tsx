      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-8">
          ...
          <button
            ...
            disabled={loading}
            className="mt-4 w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all text-sm font-medium disabled:opacity-50"
          >
