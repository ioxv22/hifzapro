...
export const reciters = [
  ...
  { id: 'ar.abdulbasitmurattal', name: 'Abdul Basit Abdul Samad', identifier: 'ar.abdulbasitmurattal' },
  ...
  { id: 'ar.saabormaher', name: 'Maher Al-Muaiqly', identifier: 'ar.mahermuaiqly' },
  { id: 'ar.shaatree', name: 'Abu Bakr Ash-Shaatree', identifier: 'ar.shaatree' },
  { id: 'ar.ahmedajamy', name: 'Ahmed ibn Ali Al-Ajamy', identifier: 'ar.ahmedajamy' },
  { id: 'ar.hudhaify', name: 'Ali Al-Hudhaify', identifier: 'ar.hudhaify' },
  { id: 'ar.muhammadayyoub', name: 'Muhammad Ayyoub', identifier: 'ar.muhammadayyoub' },
  { id: 'ar.muhammadjibreel', name: 'Muhammad Jibreel', identifier: 'ar.muhammadjibreel' },
  { id: 'ar.parhizgar', name: 'Saad Al-Ghamdi', identifier: 'ar.parhizgar' },
];

export async function fetchSurah(surahNumber: number, translationEdition: string = 'en.sahih'): Promise<{ arabic: { number: number; text: string }[]; translation: { number: number; text: string }[] }> {
  try {
    ...
    return {
      arabic: arabicData.data.ayahs.map((a: { numberInSurah: number; text: string }) => ({ number: a.numberInSurah, text: a.text })),
      translation: translationData.data.ayahs.map((a: { numberInSurah: number; text: string }) => ({ number: a.numberInSurah, text: a.text })),
    };
  } catch (error) {
...
export async function fetchAyahAudio(surahNumber: number, ayahNumber: number, reciterId: string = 'ar.alafasy'): Promise<string> {
  try {
